...
struct menu_sdl_renderer_s : menu_i {
 
};

extern menu_sdl_renderer_s menu_sdl_renderer;

NK_API void nk_init();
NK_API void nk_font_stash_begin(struct nk_font_atlas**atlas);
NK_API void nk_font_stash_end(void);
//NK_API int nk_handle_event(SDL_Event *evt);
NK_API void nk_render(bool antialias);
NK_API void nk_quit(void);
